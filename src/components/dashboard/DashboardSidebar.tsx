...
export function DashboardSidebar() {
  ...
  return (
    <>
      {/* Vertical Sidebar - Hidden on mobile, visible on LG screens */}
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all ${
                active ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/10' : 'text-gray-500 dark:text-dark-muted'
              }`}
            >
